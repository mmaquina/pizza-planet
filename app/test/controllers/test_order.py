...
def __order(ingredients: list, beverage: list, size: dict, client_data: dict):
...
def test__create__when_payload_is_ok(app, ingredients, beverages, size, client_data):
...
def test__create__when_payload_is_wrong(app, ingredients, beverages, size, client_data):
    ...
    _, error = OrderController.create(order)
    pytest.assume(error is not None)


def test_calculate_order_price(app, ingredients, beverages, size, client_data):
    created_size, created_ingredients = __create_sizes_ingredients_and_beverages(ingredients, beverages, [
        size])
